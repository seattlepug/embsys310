// this is the answer for assignment06
// it is based on starting code provided
// note that all three files are updated accordingly for this assignment
// main.c, delay.s, and user_led.s files
// all three are submitted
// but there are no real changes to the main.c file
// I only changed the duration to make sure my code works at different versions
