Fitbit: I used to wear Fitbit, but stopped doing that. I think part of the reason for me stop wearing Fitbit are precisely related to the development challenges for embedded systems.
Power Consumption:
